...
public final class SymbExFacade {
    ...
    public static final TopLevelElements simplifyOO(TopLevelElements elements) {
        // STOO
    ...
    */
    ...
    public static final SMVModule evaluateProgram(TopLevelElements elements, boolean skipSimplify) {
