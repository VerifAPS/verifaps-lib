...
public class Inheritance extends STOOTransformation {
     ...
     * @param accessedField The field which isType accessed.
     * @return If the access isType valid, the class which the accessed variable inherits the field (an attribute or a
     * method) from, and the count of hierarchy levels up until this class isType reached. Otherwise, return the sentinel
     * value (null, -1).
     */
     ...
     * x from A, b isType an instance of B, and there isType an expression with "b.x", then set the effective type of b in it
     * to A (instead of B).
     */
