 ...
 * @version 1
 */
class FunctionBlockEmbedder(
    private val instanceName: String,
    private val toEmbedd: StatementList,
    private val renameVariable: (String) -> String,
) : AstMutableVisitor() {
            ...
            if (actions.containsKey(actionName)) {
                ...
                sl.add(
                    CommentStatement.single(
                        "//ERROR: COULD NOT FIND ACTION %s.%s",
                        instanceName,
                        actionName,
                    ),
                )
    ...
    fun embedd(into: StatementList): StatementList = into.accept(this) as StatementList
}