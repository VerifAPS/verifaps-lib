 ...
 * generated in the edu.kit.iti.formal.automation.testtables.schema package. 
...
public class ObjectFactory {
    ...
    private final static QName _TestTable_QNAME = new QName("http://formal.iti.kit.edu/exteta-1.1", "test-table");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: edu.kit.iti.formal.automation.testtables.schema
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://formal.iti.kit.edu/exteta-1.1", name = "test-table")
