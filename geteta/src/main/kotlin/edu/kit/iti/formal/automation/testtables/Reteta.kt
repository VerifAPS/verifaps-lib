...
class Reteta : CliktCommand(
    ...
    override fun run() {
        ...
        //read program
        val programs = IEC61131Facade.readProgramsWithLibrary(library, programs, disableSimplify)
        ...
        val tt = TableTransformation(table, superEnumType, true)

        val modTable = tt.transform()
        val mainModule = GetetaFacade.glue(modTable, tt.model.ttType!!,
