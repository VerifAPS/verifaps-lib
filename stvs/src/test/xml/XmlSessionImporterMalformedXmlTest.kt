...
class XmlSessionImporterMalformedXmlTest(private val file: File) {
    /**
    ...
    fun sessionImporterMalformedXmlTest() {
        ImporterFacade.importSession(file, ImporterFacade.ImportFormat.XML, GlobalConfig(), History())
    }
