...
/**
 * Gets invoked by {@link ValueEnum#match}. This interface provides a way to handle an unknown value
 * by calling {@link Value#match}. If the value is an instance of {@link ValueEnum} this handler is
 * called.
 */
@FunctionalInterface
