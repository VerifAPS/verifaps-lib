 ...
 * <p>
 * <p>
 * This type does not contain all information the source expression string had. That means you can't
 * get back the expression string from this Expression. For example an expression <tt>= 3</tt> in a
 * column for {@link IoVariable} <tt>X</tt> is parsed as <tt>X = 3</tt> by the
