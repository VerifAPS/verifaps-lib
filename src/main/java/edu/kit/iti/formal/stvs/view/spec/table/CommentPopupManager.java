...
/**
 * <p>This is the class that manages a popup for a given {@link Commentable} model instance.</p>
 *
...
public class CommentPopupManager {
  ...
  /**
   * <p>This constructor opens a new {@link CommentPopup} with its text initialized to
   * the given {@link Commentable}'s comment. If the user changes the comment and closes the dialog,
   * the {@link Commentable}'s comment is updated.</p>
   *
   * <p>This constructor therefore manages the whole cycle of editing a comment
   * (open, edit, close, update).</p>
   *
   ...
   *                 viewing purposes
   * @param globalConfig a configuration that might influence the editor's appearence
