...
/**
 * Gets invoked by {@link ValueInt#match}. This interface provides a way to handle an unknown value
 * by calling {@link Value#match}. If the value is an instance of {@link ValueInt} this handler is
 * called.
 */
@FunctionalInterface
