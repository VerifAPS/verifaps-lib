...
public class DuplicateFreeVariableProblem extends FreeVariableProblem {
  ...
  /**
   * <p>Checks that the given free variable name only occurs once in the given collection,
   * else it returns a {@link DuplicateFreeVariableProblem}.</p>
   *
  ...
  private static boolean isVariableDuplicated(
      Collection<FreeVariable> allVariables, String varName) {
