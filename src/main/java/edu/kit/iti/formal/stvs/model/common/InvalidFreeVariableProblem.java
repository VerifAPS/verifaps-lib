...
public class InvalidFreeVariableProblem extends FreeVariableProblem {
  ...
  public static ValidFreeVariable tryToConvertToValid(FreeVariable freeVariable,
  ...
  private static Value tryToGetValidDefaultValue(FreeVariable freeVariable, Type freeVarType,
      Map<String, Type> typesByName) throws InvalidFreeVariableProblem {
