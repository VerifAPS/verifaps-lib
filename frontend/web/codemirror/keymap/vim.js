...
(function(mod) {
   ...
   * shortNames must not hit the prefix of the other command.
   */
  ...
  var Vim = function() {
    ...
    var vimApi= {
       ...
       * function if a partial hit is found (multi-key), and a function to
    ...
    * hit the input selection.
    ...
    var actions = {
      ...
      paste: function(cm, actionArgs, vim) {
        ...
        if (actionArgs.matchIndent) {
          ...
          // chomp last newline b/c don't want it to hit /^\s*/gm
    ...
    /**
     * Updates the CodeMirror selection to hit the provided vim selection.
    ...
    * in the right place.
    ...
    function translateRegex(str) {
      // When these hit, add a '\' if unescaped or remove one if escaped.
      var specials = '|(){';
    ...
    ExCommandDispatcher.prototype = {
      ...
      matchCommand_: function(commandName) {
        ...
        // prefix of the passed in command name. The hit is guaranteed to be
    ...
    */
    ...
    function handleExternalSelection(cm, vim) {
      ...
      // Enter or exit visual mode to hit mouse selection.
