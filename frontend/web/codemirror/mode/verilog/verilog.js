...
CodeMirror.defineMode("verilog", function(config, parserConfig) {
  ...
  */
  ...
  function buildElectricInputRegEx() {
    ...
    // or on a hit of any of the block closing keywords, at
    // the end of a line
    var allClosings = [];
        ...
        if (state.tlvCodeActive) {
          ...
          if (tlvTrackStatements) {
            ...
            beginStatement =
                   ...
                   //!stream.hit(tlvCommentMatch, false) && // not comment start
          ...
          if (style !== undefined) {
            ...
            if (// is identifier prefix
              ...
              // This enables subsequent identifier hit with preceding symbol character, which
