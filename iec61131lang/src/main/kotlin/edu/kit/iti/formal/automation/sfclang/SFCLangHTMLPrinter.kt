...
/**
 *
 * SFCLangHTMLPrinter class.
 *
 * @author weigl
 * @version $Id: $Id
 */
class SFCLangHTMLPrinter : StructuredTextHtmlPrinter()/*
    ...
    public HTMLCodeWriter visit(SFCImplementation decl) {
        ...
        hcw.keyword("sfc").append(" ").append(decl.getName()).nl()
                .increaseIndent();
    ...
    private void printAction(FunctionBlockDeclaration fbd) {
        hcw.nl().keyword("action").append(" ").append(fbd.getName());
        hcw.increaseIndent();
        hcw.nl();
